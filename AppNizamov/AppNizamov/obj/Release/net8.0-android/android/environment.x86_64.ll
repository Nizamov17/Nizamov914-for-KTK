...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 27456840410499041, ; hash 0x618bd9d35287e1, from name: AppNizamov.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppNizamov.dll.so
		ptr null; void* handle (0x0)
	}, ; 1
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 1087167100296574842, ; hash 0xf1664b7b8ab377a, from name: aot-AppNizamov.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppNizamov.dll.so
		ptr null; void* handle (0x0)
	}, ; 25
	...
	%struct.DSOCacheEntry {
		i64 3191491802663248902, ; hash 0x2c4a74e2a1506406, from name: libaot-AppNizamov.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppNizamov.dll.so
		ptr null; void* handle (0x0)
	}, ; 81
	...
	%struct.DSOCacheEntry {
		i64 7843260989363116899, ; hash 0x6cd8dc507faadb63, from name: aot-AppNizamov
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppNizamov.dll.so
		ptr null; void* handle (0x0)
	}, ; 189
	...
	%struct.DSOCacheEntry {
		i64 14032520445469264983, ; hash 0xc2bd86ff679a0c57, from name: AppNizamov
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppNizamov.dll.so
		ptr null; void* handle (0x0)
	}, ; 366
	...
	%struct.DSOCacheEntry {
		i64 14556556029526152078, ; hash 0xca034695bcfa138e, from name: libaot-AppNizamov
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppNizamov.dll.so
		ptr null; void* handle (0x0)
	}, ; 380
...
@.env.3 = private unnamed_addr constant [37 x i8] c"6aa3b38a-317b-46ab-845a-1191d8e95a22\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [27 x i8] c"com.companyname.appnizamov\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [25 x i8] c"libaot-AppNizamov.dll.so\00", align 16
