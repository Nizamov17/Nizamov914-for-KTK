...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 477352590, ; hash 0x1c73d28e, from name: aot-AppNizamov.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1395274323, ; hash 0x532a3253, from name: AppNizamov
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppNizamov.dll.so
		ptr null; void* handle (0x0)
	}, ; 148
	...
	%struct.DSOCacheEntry {
		i64 1707012707, ; hash 0x65bef263, from name: AppNizamov.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppNizamov.dll.so
		ptr null; void* handle (0x0)
	}, ; 178
	...
	%struct.DSOCacheEntry {
		i64 2462512465, ; hash 0x92c6f551, from name: libaot-AppNizamov
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppNizamov.dll.so
		ptr null; void* handle (0x0)
	}, ; 275
	...
	%struct.DSOCacheEntry {
		i64 3389751591, ; hash 0xca0b8127, from name: libaot-AppNizamov.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppNizamov.dll.so
		ptr null; void* handle (0x0)
	}, ; 385
	...
	%struct.DSOCacheEntry {
		i64 4081766346, ; hash 0xf34acfca, from name: aot-AppNizamov
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppNizamov.dll.so
		ptr null; void* handle (0x0)
	}, ; 456
